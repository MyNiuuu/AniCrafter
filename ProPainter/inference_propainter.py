...
def read_mask(mnames, length, size, flow_mask_dilates=8, mask_dilates=5):
    masks_img = []
    masks_dilated = []
    flow_masks = []
    ...
    # # last_available_mask_path = None
    # for mp in mnames:
    #     # try:
    #     mask_img = Image.open(mp)
    #     # except:
    #     #     if last_available_mask_path is not None:
    #     #         mask_img = Image.open(last_available_mask_path)
    #     #     else:
    #     #         available_mask_path = None
    #     #         countccc = 1
    #     #         while available_mask_path is None:
    #     #             if os.path.exists(mnames[countccc]):
    #     #                 available_mask_path = mnames[countccc]
    #     #         mask_img = Image.open(available_mask_path)
    #     #         last_available_mask_path = available_mask_path
    #     # else:
    #     #     last_available_mask_path = mp
...
if __name__ == '__main__':
    ...
    for gt_video in tqdm(scene_roots):
        ...
        if args.mode == 'video_inpainting':
            ...
            flow_masks, masks_dilated = read_mask(mask_video, frames_len, size, 
        ...
        # img_save_root = os.path.join(os.path.join(scene_root, 'propainter', '000000.jpg'))
